                      ...
                      >
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-gray-500 max-w-md mx-auto">
                            ...
                            securely logged in our audit trail. Our team will
                            review your eligibility and get back to you shortly.
                          </p>
                        </div>
                ...
                <aside className="space-y-6 sticky top-28">
                  <div className="bg-white rounded-2xl p-6 shadow-sm border border-black/5 space-y-4">
                    ...
                    <ul className="space-y-4 text-sm">
                      ...
                      <li className="flex gap-3">
                        <span className="w-5 h-5 rounded-full bg-gray-200 text-gray-500 text-[10px] flex items-center justify-center shrink-0">
                          2
                        </span>
                        <span className="text-gray-600">
                          Eligibility check via automated rule engine
                        </span>
                      </li>
                      <li className="flex gap-3">
                        <span className="w-5 h-5 rounded-full bg-gray-200 text-gray-500 text-[10px] flex items-center justify-center shrink-0">
